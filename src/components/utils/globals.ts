...
function createGlobal(id: string, value: GeneralType): GeneralType {
 ...
 * @returns {null}
 */
function deleteGlobal(id: string): null {
    ensureType(id, 'string');
 ...
 */
function globalExists(id: string): boolean {
    ensureType(id, 'string');
 ...
 */
function setGlobal(id: string, value: GeneralType): any {
    ensureType(id, 'string');
